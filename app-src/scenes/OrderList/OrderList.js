...
import { Container, Content, Button, ListItem, List, H3, Icon, Card, CardItem, Text, Body } from "native-base";
                            ...
                            <Card key={index}>
                                ...
                                <CardItem >
                                    <Body>
                                        <List style={{ width: screenWidth - 70 }}>
                                            {
                                                order.items && JSON.parse(order.items).map((itm, index) =>
                                                    <ListItem style={styles.listItmems}>
                                                        <Text style={{ fontSize: 12 }}>{itm.title} ({itm.qnt} x {itm.price})</Text>
                                                        <Text style={{ fontSize: 12 }}>₹{parseInt(itm.price * itm.qnt).toFixed(2)}</Text>
                                                    </ListItem>
                                             )
                                            }
                                        </List>
                                        <List style={{ width: screenWidth - 70 }}>
                                            ...
                                            <ListItem style={styles.listItmems}>
                                                ...
                                                <Text style={{ fontSize: 12 }}>₹ {parseInt(order.subtotal).toFixed(2)}</Text>
                                            </ListItem>
                                            <ListItem style={styles.listItmems}>
                                                <Text style={{ fontSize: 12 }}>Delivery</Text>
                                                <Text style={{ fontSize: 12 }}>₹ {parseInt(order.delivery).toFixed(2)}</Text>
                                            </ListItem>
                                            <ListItem style={styles.listItmems}>
                                                <Text style={{ fontSize: 12 }}>To Pay</Text>
                                                <Text style={{ fontSize: 12 }}>₹ {parseInt(order.total).toFixed(2)}</Text>
                                            </ListItem>
                                        </List>
                                        <List style={{ width: screenWidth - 70 }}>
                                            <ListItem style={styles.listItmems}>
