...
export const  checkMobile = async (no) => {
  ...
  const encodeForm = (data) => {
      ...
      return  axios.post(baseUrl+'/checkMobile', encodeForm(formData), {headers: {'Accept': 'application/json'}})
...
export const  sendOTP = async (no) => {
  ...
  const encodeForm = (data) => {
      ...
      return  axios.post(baseUrl+'/sendOtp', encodeForm(formData), {headers: {'Accept': 'application/json'}})
            .then(function (response) {
...
export const  getLoginUser = async (no) => {
  ...
  const encodeForm = (data) => {
      ...
      return  axios.post(baseUrl+'/getUser', encodeForm(formData), {headers: {'Accept': 'application/json'}})
            .then(function (response) {
                return response.data
            })
            .catch(function (error) {
...
export const  saveUser = async (formData) => {
  const encodeForm = (data) => {
      ...
      return  axios.post(baseUrl+'/Registration', encodeForm(formData), {headers: {'Accept': 'application/json'}})
            .then(function (response) {
                return response.data
            })
            .catch(function (error) {
